      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              <li class="active"><i class="fa fa-university"></i>Edit Club Post</li>
            </ol>
            ...
            <div class="row">
                <!-- <div class="col-lg-12"> -->
                  ...
                  <div class="col-lg-6">
                    ...
                    <?php echo form_open('FacAdmin/edit_Clubs/'.$row->clubid); ?>

                      <div class="form-group">
                      <label>Club Name</label>
                          <input type="text" class="form-control" name="clubname" value="<?php echo $row->clubname ?>">
                      </div>
                      <div class="form-group">
                          <label>Faculty</label>
                      ...
                      <label>Deadline date</label>
                          <input type="date" class="form-control" name="clubdate" value="<?php echo $row->clubdate ?>">
                      </div>
                      <div class="form-group">
                          <label>Time</label>
                          <input type="time" class="form-control" name="clubtime" value="<?php echo $row->clubtime ?>">
                      </div>
                      <br><br>
                      <button class="btn btn-primary" type="submit" name="update">Update</button>
                      <a href="<?php echo site_url('FacAdmin/viewAllClubs') ?>" class="btn btn-link">Back to Clubs</a><br><br>
