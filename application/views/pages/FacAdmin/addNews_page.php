    ...
    <div id="wrapper">
      ...
      <div class="collapse navbar-collapse navbar-ex1-collapse">
          ...
          <ul class="nav navbar-nav side-nav">
            ...
            <li class="active"><a href="<?php echo site_url("FacAdmin/addNews") ?>"><i class="fa fa-file-text-o"></i> Add Faculty News</a></li>
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <h2>Post News for faculty</h2><br>

            <ol class="breadcrumb">
              <li class="active"><i class="fa fa-file-text-o"></i>Publish a news</li>
            </ol>
          </div>
          ...
          <div class="col-lg-6">
            ...
            <?php echo form_open('FacAdmin/addNewsByFacAdmin'); ?>
