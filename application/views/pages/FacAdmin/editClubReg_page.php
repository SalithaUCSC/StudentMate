            ...
            <div class='panel panel-default'>
              <div class='panel-body'>
                ...
                <?php endif; ?>
                  ...
                  <?php echo form_open('FacAdmin/edit_clubReg/'.$row->c_id); ?>
                    ...
                    <label>Club DB Value</label>
                        <input type="text" class="form-control" name="c_value" value="<?php echo $row->c_value;?>">
                    </div>
                    <div class="form-group">
                    <label>Faculty</label>
                    ...
                    <br>
                    <button class="btn btn-primary" type="submit" name="update">Update Club</button>
                    <a href="<?php echo site_url('FacAdmin/viewClubUsers') ?>" class="btn btn-link">Back to Clubs</a><br><br>
