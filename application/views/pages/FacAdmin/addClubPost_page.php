    ...
    <div id="wrapper">
      ...
      <!-- Sidebar -->
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          ...
          <ul class="nav navbar-nav side-nav">
            ...
            <li class="active"><a href="#"><i class="fa fa-university"></i>Add Club Post</a></li>
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <h2>Post Faculty Club Recruitements</h2><br>

            <ol class="breadcrumb">
              <li class="active"><i class="fa fa-cc-diners-club"></i>Publish club news</li>
            </ol>
          </div>
            ...
            <div class='panel panel-default'>
              <div class='panel-body'>
                ...
                <?php endif; ?>
                  ...
                  <?php echo form_open('FacAdmin/addClubsByFacadmin'); ?>
                    ...
                    <label>Deadline date</label>
                        <input type="date" class="form-control" name="clubdate">
                    </div>
                    <div class="form-group">
                        <label>Time</label>
                        <input type="time" class="form-control" name="clubtime">
                    </div>

                    <br>
                    <button class="btn btn-primary" type="submit" name="addnewsbtn">Publish</button>
