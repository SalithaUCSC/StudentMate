                  ...
                  <div class="row" style="text-align: center;">
                      ...
                      <div class="thumbnail">
                        ...
                        <div class="caption">
                          ...
                          <a href="<?php echo base_url('Admin/editAdmin/'.$_SESSION['user_id']) ?>" class="btn btn-primary" role="button" name="update">Update Profile</a><br><br>
                          <a href="<?php echo site_url('Admin') ?>" class="btn btn-link">Back to Home</a>
