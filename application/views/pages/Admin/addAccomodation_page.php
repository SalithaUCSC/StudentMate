      ...
      <!-- Sidebar -->
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          ...
          <ul class="nav navbar-nav side-nav">
            ...
            <li class="active"><a href="#"><i class="fa fa-home"></i>Add Accomodation</a></li>
        ...
        <div id="page-wrapper">
          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <ol class="breadcrumb">
                <li class="active"><i class="fa fa-home"></i>Add Accommodation post</li>
              </ol>
            </div>
          </div>
              ...
              <div class="col-lg-12">
                ...
                <div class='panel panel-default'>
                  <div class='panel-body'>
                      ...
                      <?php echo form_open('Admin/addAccomodation'); ?>

                        <div class="form-group">
                        <label>Accomodation Tile</label>
                            <input type="text" class="form-control" name="ac_title">
                        </div>
                        <label>Description</label>
                          <textarea class="form-control" rows="5" name="ac_content"></textarea>
                        <br>
                        <div class="form-group">
                            <label>Publish Date</label>
                            <input type="date" class="form-control" name="ac_date">
                        </div>
                        <div class="form-group">
                            <label>Time</label>
                            <input type="time" class="form-control" name="ac_time">
                        </div>

                        <button class="btn btn-primary" type="submit" name="addaccomo">Add Post</button>
